...
This file lists every repo file along with naming, metadata, and classification guidance for Arweave anchoring.
...
| alvearium-0.1-alpha/README_dev.md | Index/README | `TO-FILL` | `alvearium-0_1-alpha_readme_dev_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/README_timelines.md | Index/README | `TO-FILL` | `alvearium-0_1-alpha_readme_timelines_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/glossary.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_glossary_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/agent_bootstrap.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_agents_agent_bootstrap_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/agents_manifesto.md | Manifesto | `TO-FILL` | `alvearium-0_1-alpha_agents_agents_manifesto_md` | Yes | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/agents_next_steps.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_agents_agents_next_steps_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/builder_drone.json | General Doc | `TO-FILL` | `alvearium-0_1-alpha_agents_builder_drone_json` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/guardian_drone.json | General Doc | `TO-FILL` | `alvearium-0_1-alpha_agents_guardian_drone_json` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/agents/scholar_drone.json | General Doc | `TO-FILL` | `alvearium-0_1-alpha_agents_scholar_drone_json` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/code/init_scripts/swarm_init.sh | Script/Bootstrap | `TO-FILL` | `alvearium-0_1-alpha_code_init_scripts_swarm_init_sh` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/CLI_USAGE.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_cli_usage_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/architecture.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_architecture_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/chronosphere.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_chronosphere_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/contracts.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_contracts_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/interfaces.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_interfaces_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/layers.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_layers_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/mirror_init.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_mirror_init_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/nectar.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_nectar_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/reference.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_reference_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/security.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_security_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/substrate_structures.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_substrate_structures_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/trust.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_trust_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/bootstrap/trust_bootstrap.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_bootstrap_trust_bootstrap_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/lorechain/tokens_lorechain.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_lorechain_tokens_lorechain_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/docs/lorechain/view_lorechain.md | General Doc | `TO-FILL` | `alvearium-0_1-alpha_docs_lorechain_view_lorechain_md` | No | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/manifestos/Manifesto_alvearium.md | Manifesto | `TO-FILL` | `alvearium-0_1-alpha_manifestos_manifesto_alvearium_md` | Yes | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/manifestos/Manifesto_hive.md | Manifesto | `TO-FILL` | `alvearium-0_1-alpha_manifestos_manifesto_hive_md` | Yes | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/manifestos/Manifesto_kernel69.md | Manifesto | `TO-FILL` | `alvearium-0_1-alpha_manifestos_manifesto_kernel69_md` | Yes | [Link](https://arweave.net/TO-FILL) |
| alvearium-0.1-alpha/manifestos/Manifesto_nectar.md | Manifesto | `TO-FILL` | `alvearium-0_1-alpha_manifestos_manifesto_nectar_md` | Yes | [Link](https://arweave.net/TO-FILL) |
...
| alvearium-0.1-alpha/schematics/schematic_emission_cycles.png | Schematic | `TO-FILL` | `alvearium-0_1-alpha_schematics_schematic_emission_cycles_png` | No | [Link](https://arweave.net/TO-FILL) |
...
| alvearium-0.1-alpha/schematics/schematic_mirror_forking.png | Schematic | `TO-FILL` | `alvearium-0_1-alpha_schematics_schematic_mirror_forking_png` | No | [Link](https://arweave.net/TO-FILL) |
...
| alvearium-0.1-alpha/schematics/schematic_triggerstack_logic.png | Schematic | `TO-FILL` | `alvearium-0_1-alpha_schematics_schematic_triggerstack_logic_png` | No | [Link](https://arweave.net/TO-FILL) |
